...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("**** CSharpHava Yolları Yolcu Bilgisi ****");
            //Console.WriteLine();

            //string passengerName, passengerSuename, passengerDistrict, passengerCity,
            ...
            //passengerSuename = Console.ReadLine();
            ...
            //Console.WriteLine("-----------------------");
            //Console.WriteLine("Yolcu Adı : " + passengerName + "  " + passengerSuename + " Yolcu İlçe Bilgisi: " + 
            //    passengerDistrict + " Yolcu Şehir Bilgisi: " + passengerCity + " Yolcu Yaş Bilgisi " + passengerAge +
            //    " Yolcu TC Kimlik Bilgisi: " + passengerIdentityNumber );
