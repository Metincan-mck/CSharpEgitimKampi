...
namespace _07_ForeachLoop
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //string[] cities = { "Mmilano", "roma", "budapeşte", "ankara", "istanbul", "varşova" };
            ...
            #region Örnek Sınav Sistemni Uygulaması
            ...
            //Sınıftaki ögrenci sayısını kullanıcıdan alma
            Console.WriteLine("------------------------------");
            ...
            for (int i = 0; i < studentCount; i++)
            {
                ...
                for (int j = 0; j < 3; j++)
                {
                    Console.Write($"{studentNames[i]} isimli ögrencinin {j + 1}. sınav notunu giriniz: ");
